...
layout: "chapter"
lang: en
title: "✍️ Operation Ghostwriter: Build a Marketing Content Agent with Skills"
short_title: "Operation Ghostwriter"
description: "A Special Ops lab for building a modern marketing content agent with Skills instead of one giant instruction block."
order: 999
...
**Translated article** — This article is based on [✍️ Build a Marketing Content Agent with Skills](https://microsoft.github.io/agent-academy/special-ops/ghostwriter/) from the [Copilot Studio Agent Academy](https://microsoft.github.io/agent-academy/). The original wording takes precedence.
</div>

# ✍️ Operation Ghostwriter: Build a Marketing Content Agent with Skills

<figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/ghostwriter-badge.png' | relative_url }}" alt="Operation Ghostwriter Badge" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Operation Ghostwriter Badge</figcaption></figure>
...
### Instructions vs. a Series of Skills
...
## 🚪 Two Ways to Get a Skill Into Copilot Studio
...
## 🧪 Lab 1.1: Create the agent with lean instructions
...
1. On the home page, select **Agent**.
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.1_01_CreateAgent.png' | relative_url }}" alt="Agent option on the Copilot Studio home page" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Agent option on the Copilot Studio home page</figcaption></figure>
...
1. Select the **Instructions** field and copy and paste only the global behavior:
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.1_02_Instructions-annotated.png' | relative_url }}" alt="Lean prompt entered in the Instructions field" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Lean prompt entered in the Instructions field</figcaption></figure>
...
## 🧪 Lab 1.2: Build the `draft-blog-post` Skill from scratch
...
1. In the **Build** editor, find the **Skills** card in the configuration panel on the right and select **Add skill**.
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.2_01_AddSkill-annotated.png' | relative_url }}" alt="Add skill card in the agent configuration panel" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Add skill card in the agent configuration panel</figcaption></figure>
...
1. The **Add skill** dialog offers two methods: **Upload a skill** (drag in a Markdown Skill file) and **Create from blank** (fill in the fields directly). Select **Create from blank**.
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.2_03_CreateFromBlank.png' | relative_url }}" alt="Create from blank tab in the Add skill dialog" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Create from blank tab in the Add skill dialog</figcaption></figure>
...
1. Select **Create** to add the Skill
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.2_04_CreateBlogSKill.png' | relative_url }}" alt="Completed draft blog post Skill configuration" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Completed draft blog post Skill configuration</figcaption></figure>
...
## 🧪 Lab 1.3: Build the `seo-audit` Skill from an example
...
Download link: [Download the prepared Skill files](https://download-directory.github.io/?url=https://github.com/microsoft/agent-academy/tree/main/docs/special-ops/ghostwriter/assets/skills&filename=ghostwriter-skills)

1. Extract the downloaded ZIP file, then open and review [`seo-audit.md`](https://github.com/microsoft/agent-academy/blob/main/docs/special-ops/ghostwriter/assets/skills/seo-audit.md).
...
1. Back on the **Build** tab, find the **Skills** card and select the **plus button**.
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.3_addskill.png' | relative_url }}" alt="Plus button beside Skills in the Build panel" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Plus button beside Skills in the Build panel</figcaption></figure>

1. This time we will choose the **Upload a skill** option.

    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.3_uploadskill.png' | relative_url }}" alt="Upload a skill tab in the Add skill dialog" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Upload a skill tab in the Add skill dialog</figcaption></figure>
...
## 🧪 Lab 1.4: Build the `repurpose-to-social` Skill

Next, you'll repeat the upload pattern with a Skill that adapts long-form content for individual social channels.

1. Open `repurpose-to-social.md` from the extracted Skill files and give it a quick read. You can also [preview the file](https://github.com/microsoft/agent-academy/blob/main/docs/special-ops/ghostwriter/assets/skills/repurpose-to-social.md) online.
...
1. Drag `repurpose-to-social.md` into the upload area. Select it from the **Skills** section and confirm that all properties mapped correctly.
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.4_skillfilled.png' | relative_url }}" alt="Imported repurpose-to-social Skill fields in the Build panel" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Imported repurpose-to-social Skill fields in the Build panel</figcaption></figure>

## 🧪 Lab 1.5: Build the `brand-voice-check` Skill

Complete the agent's core Skill set by adding a reusable brand-voice review procedure.

1. Open `brand-voice-check.md` from the extracted Skill files and read it. You can also [preview the file](https://github.com/microsoft/agent-academy/blob/main/docs/special-ops/ghostwriter/assets/skills/brand-voice-check.md) online.
...
1. Drag `brand-voice-check.md` into the upload area. Select it from the **Skills** section and confirm that all properties mapped correctly.
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.5_skillfilled.png' | relative_url }}" alt="Skills card showing all four marketing Skills" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Skills card showing all four marketing Skills</figcaption></figure>

## 🧪 Lab 1.6: Test Multi-Skill Orchestration
...
1. Select the **Preview** tab at the top of your agent.
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.5_previewtab.png' | relative_url }}" alt="Preview tab for the Fabrikam Content Agent" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Preview tab for the Fabrikam Content Agent</figcaption></figure>
...
1. Copy and paste the following prompt and press **Enter**:
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.6.01_prompt.png' | relative_url }}" alt="Composite launch package prompt entered in Preview" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Composite launch package prompt entered in Preview</figcaption></figure>
...
1. Review the activity trace. For this composite request, the expected result is for the agent to load all four Skills: `draft-blog-post`, `seo-audit`, `repurpose-to-social`, and `brand-voice-check`.
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.6.02_chaining.png' | relative_url }}" alt="Activity trace showing four loaded Skills" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Activity trace showing four loaded Skills</figcaption></figure>
...
1. Review the response. It might provide a Markdown file or render the artifacts directly in the chat. If it creates a file, select the file to review it.
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.6.03_file.png' | relative_url }}" alt="Generated Trailburst launch package file in Preview" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Generated Trailburst launch package file in Preview</figcaption></figure>
...
1. Review the file and confirm it includes:
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.6.04_filereview.png' | relative_url }}" alt="Generated blog post with SEO metadata" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Generated blog post with SEO metadata</figcaption></figure>

    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.6.04_filereview2.png' | relative_url }}" alt="SEO audit showing checks and applied fixes" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>SEO audit showing checks and applied fixes</figcaption></figure>
...
1. In **Preview**, select **New chat** so the previous request doesn't influence this test.
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.6.06_newchat.png' | relative_url }}" alt="New chat button in the Preview toolbar" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>New chat button in the Preview toolbar</figcaption></figure>
...
1. Enter the following request:
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.6.07_newprompt.png' | relative_url }}" alt="Product naming request entered in a new Preview chat" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Product naming request entered in a new Preview chat</figcaption></figure>
...
1. Review the response. None of the four Skills should activate because naming a product isn't one of their defined jobs. The agent can respond using its general Instructions.
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.6.08_response.png' | relative_url }}" alt="General product naming response with no marketing Skills activated" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>General product naming response with no marketing Skills activated</figcaption></figure>
...
## 🧪 Lab 1.7 (Optional): Build a Skill with AI
...
1. Enter the following prompt in the chat, then press **Enter**:
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.7_skillprompt.png' | relative_url }}" alt="Video-script Skill generation prompt entered in Preview" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Video-script Skill generation prompt entered in Preview</figcaption></figure>
...
1. **Review the provided Markdown.** Ensure that it's safe and accurate, then make any necessary changes. Select the **Copy** icon in the upper-right corner.
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.7_reviewcopy.png' | relative_url }}" alt="Generated video-script Markdown ready to copy" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Generated video-script Markdown ready to copy</figcaption></figure>
...
1. Select the **Build** tab to go back to your agent configuration.
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.7-addskill.png' | relative_url }}" alt="Build tab after returning from Preview" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Build tab after returning from Preview</figcaption></figure>

1. Select the **plus button** next to **Skills**.

    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.7_plusskill.png' | relative_url }}" alt="Plus button beside Skills in the Build panel" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Plus button beside Skills in the Build panel</figcaption></figure>
...
1. Select **Create from blank**. Fill in the **Name**, **Description**, and **Instructions** according to the Markdown file created in the previous step, then select **Create**.
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.7_createskill.png' | relative_url }}" alt="Create from blank fields for the video-script Skill" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Create from blank fields for the video-script Skill</figcaption></figure>
...
1. Go back to the **Preview** tab. Select **New Chat** to start a new test session. Type the following text and press **Enter**:
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.7_testprompt.png' | relative_url }}" alt="Short-form video script test prompt in Preview" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Short-form video script test prompt in Preview</figcaption></figure>

1. Review the response, making sure it calls the video-script skill and produces a good script.

    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.7-test.png' | relative_url }}" alt="Generated response using the video-script Skill" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Generated response using the video-script Skill</figcaption></figure>

## 🧠 Bonus: Personalize the agent with Memory
...
1. Turn on **Memory** in the components panel.
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.8.01_memorytoggle.png' | relative_url }}" alt="Memory toggle enabled in the agent Build panel" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Memory toggle enabled in the agent Build panel</figcaption></figure>
...
1. Open **Preview**, then select **New chat**. You'll see a message letting you know memories are enabled. Copy and paste the following prompt and press **Enter**:
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.8.02_memoryprompt.png' | relative_url }}" alt="Request to remember personal LinkedIn post preferences" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Request to remember personal LinkedIn post preferences</figcaption></figure>

1. The agent will respond with confirmation that it saved the memory.

    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.8.03_memoryconfirm.png' | relative_url }}" alt="Agent confirmation that the LinkedIn preferences were saved" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Agent confirmation that the LinkedIn preferences were saved</figcaption></figure>
...
1. Start a new chat. Copy and paste the following prompt to request the agent to create a new LinkedIn post to test the memory:
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.8.05_memorytest.png' | relative_url }}" alt="LinkedIn post request without repeating the saved preferences" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>LinkedIn post request without repeating the saved preferences</figcaption></figure>
...
1. Confirm that the response activates the `brand-voice-check` Skill and applies your saved preference: fewer than 700 characters, no emoji, and one direct call to action.
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/1.8.06_memorytestresponse.png' | relative_url }}" alt="LinkedIn response applying the brand voice Skill and saved preferences" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>LinkedIn response applying the brand voice Skill and saved preferences</figcaption></figure>
...
<figure class="screenshot"><img src="{{ '/assets/academy/special-ops-ghostwriter/ghostwriter-badge.png' | relative_url }}" alt="Operation Ghostwriter completion badge" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Operation Ghostwriter completion badge</figcaption></figure>
