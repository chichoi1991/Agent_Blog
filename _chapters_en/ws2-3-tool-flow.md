...
In this workshop you extend the email-sending connector scenario from Step 2 into a single flow
...
Because this flow now covers the email step you configured in Step 2, first turn **off** the
