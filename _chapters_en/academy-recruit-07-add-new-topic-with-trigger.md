...
lang: en
date: 2026-08-06
title: "Mission 07: Add a new topic with triggers and nodes"
short_title: "Add topics and triggers"
description: "Use Topics to define custom question-and-answer paths"
order: 7
...
**Translated article** — This article is based on [🚨 Mission 07: Add new topic with trigger and nodes](https://microsoft.github.io/agent-academy/recruit/07-add-new-topic-with-trigger/) from the [Copilot Studio Agent Academy](https://microsoft.github.io/agent-academy/). The original wording takes precedence.
</div>

🎥 **Watch the Walkthrough**

<figure class="screenshot"><img src="{{ '/assets/academy/recruit-07-add-new-topic-with-trigger/video-thumbnail.jpg' | relative_url }}" alt="Video walkthrough: Add a Topic with Triggers" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption><a href="https://www.youtube.com/watch?v=7iPAZaA8nJs">Watch the walkthrough on YouTube</a></figcaption></figure>
...
<div class="info-box note" markdown="1">
**TIP** — Think of tools as "action blocks" that give your agent superpowers to do things beyond _chatting_, such as calling an API, running a process, or collecting user input automatically.
</div>
...
1. The **Topic details** pane has now loaded. Select the **Input** tab.
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/recruit-07-add-new-topic-with-trigger/7.2_02_SelectInputTab.png' | relative_url }}" alt="Topic details pane with Input tab selected" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Topic details pane with Input tab selected</figcaption></figure>
...
1. Copy and paste the following as the description.
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/recruit-07-add-new-topic-with-trigger/7.2_06_InputDescription.png' | relative_url }}" alt="Input variable description with possible device values" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Input variable description with possible device values</figcaption></figure>
...
1. Update the following properties.
    ...
    **Variable description** - Copy and paste the following.
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/recruit-07-add-new-topic-with-trigger/7.2_09_OutputVariable.png' | relative_url }}" alt="VarAvailableDevices output configured as a table" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>VarAvailableDevices output configured as a table</figcaption></figure>
...
1. Select the **Inputs** tab, then select the **Contoso IT** site and the **Devices** list that you set up in [Mission 00 - Course Setup - Step 5: Create new SharePoint site]({{ '/en/chapters/academy-recruit-00-course-setup/' | relative_url }}).
...
1. Now, to only display devices from the SharePoint list based on
    ...
    <figure class="screenshot"><img src="{{ '/assets/academy/recruit-07-add-new-topic-with-trigger/7.3_07_SelectVariable.png' | relative_url }}" alt="Filter Query field with Choose a value control" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption>Filter Query field with Choose a value control</figcaption></figure>
...
Next, continue to [Mission 08: Enhance Topics with Adaptive Cards]({{ '/en/chapters/academy-recruit-08-add-adaptive-card/' | relative_url }}).
