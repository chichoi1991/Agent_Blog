...
> 📖 **참조**: [Copilot Studio governance principles](https://learn.microsoft.com/ko-kr/microsoft-365/copilot/extensibility/copilot-studio-experience#copilot-studio-governance-principles)
...
| 영역 | 체크 항목 | 참조 |
|---|---|---|
| **환경 분리** | Dev / Test / Prod 환경을 분리하여 관리 | [Learn](https://learn.microsoft.com/ko-kr/power-platform/admin/environments-overview) |
| **권한 최소화** | Agent 편집 권한(Maker)은 최소 인원에게만 부여 | |
| **DLP 정책** | 커넥터 사용 제어, 외부 데이터 반출 차단 설정 | [Learn](https://learn.microsoft.com/ko-kr/power-platform/admin/wp-data-loss-prevention) |
...
| **감사 로그** | Microsoft Purview Audit Log + Sentinel 연계 | [Learn](https://learn.microsoft.com/ko-kr/microsoft-copilot-studio/analytics-overview) |
| **ALM** | Solution 단위 패키징, 환경 간 Export/Import | |
| **변경 관리** | 지침·Knowledge 변경 시 검토→승인→게시 프로세스 | |

<div class="info-box tip">
<b>💡 실무 팁 — 하나의 업무 영역부터 시작하세요</b><br>
조직 공용 Agent를 처음 도입할 때는 <b>하나의 업무 영역</b>에 집중하세요. "모든 것을 다 해결하는 Agent"보다 <b>"특정 업무를 확실하게 처리하는 Agent"</b>가 사용자 신뢰를 빠르게 확보합니다. 성공 사례를 만든 후 다른 업무 영역으로 확장하는 것이 가장 효과적인 전략입니다.
</div>
...
### 4.3 모니터링 — Application Insights 연동
...
<b>📌 다음 챕터 미리보기</b><br>
조직 Agent 운영 방법을 익혔습니다. 마지막 <b>Chapter 8</b>에서는 참고할 공식 문서 링크와 향후 아키텍처 확장 방향을 정리합니다.
</div>
