...
<figure class="screenshot"><img src="{{ '/assets/academy/recruit-09-add-an-agent-flow/video-thumbnail.jpg' | relative_url }}" alt="Agent flow video thumbnail" loading="lazy" onerror="this.style.display='none';this.parentNode.classList.add('pending')"><figcaption><a href="https://www.youtube.com/watch?v=vtLZJT3eBXg">YouTube에서 워크스루 보기</a></figcaption></figure>
