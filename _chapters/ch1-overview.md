...
> 📖 **참조**: [Copilot Studio overview](https://learn.microsoft.com/ko-kr/microsoft-copilot-studio/fundamentals-what-is-copilot-studio)
...
> 📖 **참조**: [Copilot Studio application card – Key features](https://learn.microsoft.com/ko-kr/microsoft-copilot-studio/system-service-card-copilot-studio#key-features-or-capabilities)
...
- **Anthropic Claude Sonnet** 계열 (조직 정책으로 허용 및 차단 가능)
- **xAI Grok** 계열 (조직 정책으로 허용 및 차단 가능)

Agent 생성 시 **기본 모델을 선택**할 수 있으며, 모델에 따라 성능과 응답 특성이 달라집니다. Microsoft는 고객 데이터를 사용하여 기반 모델을 훈련하지 않습니다.

> 📖 **참조**:<br> 
[지역별 내가 사용할 수 있는 언어 모델 확인](https://learn.microsoft.com/ko-kr/microsoft-copilot-studio/authoring-select-agent-model#model-availability-by-region)

<div class="info-box note">
<b>📌 Reasoning 모델 사용 시 과금 주의</b><br>
Reasoning 모델(고급 추론)을 사용하면 기본 기능 요금 + <b>Text and generative AI tools (premium)</b> 요금이 함께 부과됩니다. 예: Generative Answer에 Reasoning 모델 사용 시 = 2 Credits (생성형 응답) + 100 Credits (프리미엄 AI 도구) = 총 102 Credits 소모.
...
| **프리뷰 사이트** | [copilotstudio.preview.microsoft.com](https://copilotstudio.preview.microsoft.com/) |
...
중요! Teams App 내에 있는 Copilot Studio app은 기본적으로 한국에서 제공되지 않는 Legacy 기능입니다. 에이전트 개발에는 반드시 웹 앱을 이용해 주세요.

> 📖 **참조**: [VS Code extension for Copilot Studio](https://learn.microsoft.com/ko-kr/microsoft-copilot-studio/visual-studio-code-extension-overview) · [Quickstart guide](https://learn.microsoft.com/ko-kr/microsoft-copilot-studio/nlu-gpt-quickstart)

<div class="info-box warning">
<b>⚠️ 접속 전 확인사항</b><br>
<ul>
<li>조직의 <b>Entra ID(구 Azure AD)</b> 계정으로 로그인해야 합니다. 개인 Microsoft 계정(@outlook.com, @hotmail.com 등)으로는 접속할 수 없습니다.</li>
<li>조직 네트워크에서 <b>*.powerva.microsoft.com</b>, <b>*.directline.botframework.com</b> 등 Power Platform 관련 URL이 차단되어 있지 않은지 확인하세요. Conditional Access / Proxy / MDCA와 충돌하는 사례가 빈번합니다.</li>
</ul>
</div>

> 📖 **참조**: [Required services and network URLs](https://learn.microsoft.com/ko-kr/microsoft-copilot-studio/requirements-quotas#required-services)
...
> 📖 **참조**: [Copilot Studio licensing](https://learn.microsoft.com/ko-kr/microsoft-copilot-studio/billing-licensing) · [Power Platform licensing FAQ](https://learn.microsoft.com/ko-kr/power-platform/admin/powerapps-flow-licensing-faq#microsoft-copilot-studio)
...
| **환경 작성자<br>(Enviorment Maker)** | Agent 생성 및 편집, Topic/Action 구성, 게시 | 시민 개발자, 현업 담당자 |
...
> 📖 **참조**: [Assign licenses and manage access](https://learn.microsoft.com/ko-kr/microsoft-copilot-studio/requirements-licensing)

<div class="info-box tip">
<b>💡 실무 팁 — "제작 권한"과 "실행 과금"은 별개입니다</b><br>
<ul>
<li><b>Agent를 만드는 권한</b>: Copilot Studio User 라이선스 (무료) 또는 Maker 역할</li>
<li><b>Agent를 사용할 때 과금</b>: Copilot Credits 기반 (M365 Copilot 사용자는 B2E 무료)</li>
</ul>
...
## 4. 과금 구조 상세 (Copilot Credits)

### 4.1 Copilot Credits란?
...
> 📖 **참조**: [Billing rates and management](https://learn.microsoft.com/ko-kr/microsoft-copilot-studio/requirements-messages-management)

### 4.2 기능별 크레딧 소모 기준
> 2026년 4월 7일 기준이며, 자세한 내용은 상단의 공식 참조 문서를 확인하시길 바랍니다. 
...
>
> 📖 **참조**: [Copilot Credits billing rates](https://learn.microsoft.com/ko-kr/microsoft-copilot-studio/requirements-messages-management#copilot-credits-billing-rates) · [Agent usage estimator](https://microsoft.github.io/copilot-studio-estimator/)

### 4.3 M365 Copilot 사용자 무료 사용 조건
...
<div class="info-box tip">
<b>💡 과금의 본질 한 줄 요약</b><br>
<b>"누가(사용자 vs 시스템), 어떻게(대화 vs 자동화), 어떤 인증으로(Entra ID vs Anonymous) 쓰느냐"</b>가 과금의 핵심입니다. 사람이 직접 쓰는 Copilot 기반 업무는 무료 범위가 넓지만, 시스템이 대신 일을 하면 그때부터 과금이 발생합니다.
</div>

### 4.4 Power Automate 플로우와 과금 관계

Power Automate 플로우를 Copilot Studio에서 사용할 때 과금 기준이 변경됩니다.

| 변경 전(Power Automate 플로우) | 변경 후(Copilot Studio Agent Flow) |
|---|---|
...
<div class="info-box warning">
<b>⚠️ 주의! 이 설정은 되돌릴 수 없습니다! </b><br>
Copilot Studio Plan으로 변경한 Flow는 <b>User/Process 라이선스로 되돌릴 수 없습니다</b>. <br> 필요 시 Flow를 처음부터 재생성해야 합니다. 변경 전에 반드시 영향 범위를 확인하세요.
</div>

### 4.5 크레딧 모니터링 및 초과 관리

| 기능 | 설명 | 참조 |
|---|---|---|
| **소비량 확인** | Power Platform Admin Center → Licensing → Copilot Studio | [Learn](https://learn.microsoft.com/ko-kr/power-platform/admin/manage-copilot-studio-messages-capacity) |
| **Agent별 한도 설정** | 개별 Agent의 월간 크레딧 상한 설정 가능 | Admin Center → Manage Agents |
| **초과 시 동작** | Prepaid 소진 시 → PAYG 자동 전환 (Azure 구독 연결 및 명시적 설정 필요) | [Learn](https://learn.microsoft.com/ko-kr/microsoft-copilot-studio/requirements-messages-management#overage-enforcement) |
...
<div class="info-box tip">
<b>💡 실무 팁 — 비용 관리 전략</b><br>
<ul>
<li><b>Estimator 활용</b>: 에이전트 배포 전에 <a href="https://microsoft.github.io/copilot-studio-estimator/" target="_blank">Microsoft Copilot Studio agent usage estimator</a>로 예상 소비량을 반드시 확인하세요.</li>
<li><b>Agent별 한도 설정</b>: 전사 배포 시 Agent별 월간 크레딧 상한을 설정하여 예기치 않은 비용 폭증을 방지하세요.</li>
<li><b>PAYG 안전망</b>: Prepaid 크레딧 팩 + PAYG(Azure 구독)를 함께 설정하면, 크레딧 소진 시에도 서비스가 중단되지 않습니다.</li>
<li><b>Dataverse Shadow Cost 주의</b>: Knowledge 소스로 파일을 업로드하면 Dataverse 스토리지가 소비됩니다. 전사 PoC 시 환경/용량 가이드를 반드시 확인하세요.</li>
</ul>
</div>

---

## 5. Copilot Chat / Agent Builder / Copilot Studio 차이
...
> 📖 **참조**: [Choose between Microsoft 365 Copilot and Copilot Studio](https://learn.microsoft.com/ko-kr/microsoft-365/copilot/extensibility/copilot-studio-experience) · [Copy agent to Copilot Studio](https://learn.microsoft.com/ko-kr/microsoft-365/copilot/extensibility/copy-agent-to-copilot-studio)

### 5.2 핵심 판단 기준

> **"정보를 찾기만 하면 → Agent Builder, <br> 실제로 작업(액션)을 시키거나, 상황에 따라서 직접 활동하길 원하면 → Copilot Studio"**
...
### 5.3 Agent Builder → Copilot Studio 확장
...
<div class="info-box tip">
<b>💡 실무 팁 — 단계적 접근 권장</b><br>
처음부터 Copilot Studio로 복잡하게 시작하지 마세요. <b>Agent Builder로 빠르게 프로토타입</b>을 만들어 사용자 반응을 확인한 후, 기능이 더 필요할 때 <b>Copilot Studio로 확장</b>하는 방식이 가장 효과적입니다. "빠르게 시작 → 점진적 확장"이 실무에서 검증된 전략입니다.
</div>
...
> 📖 **참조**: [Intended uses of Copilot Studio](https://learn.microsoft.com/ko-kr/microsoft-copilot-studio/system-service-card-copilot-studio#intended-uses)

### 6.2 2. Microsoft 365 Copilot 확장
...
> 📖 **참조**: [Extend Microsoft 365 Copilot with agents](https://learn.microsoft.com/ko-kr/microsoft-copilot-studio/microsoft-copilot-extend-copilot-extensions)

### 6.3 3. Agent 간 연동 (Multi-Agent)
...
<div class="info-box note">
<b>📌 다음 챕터 미리보기</b><br>
이번 챕터에서 Copilot Studio가 무엇인지, 어떻게 접속하고, 과금이 어떻게 되는지를 파악했습니다. 다음 <b>Chapter 2</b>에서는 실제 Copilot Studio에 접속했을 때 보이는 <b>화면 구성</b>과 핵심 개념(Agent, Topics, Knowledge, Actions)을 하나씩 살펴봅니다.
</div>
