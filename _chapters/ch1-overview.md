...
> 📖 **참조**: [Select a primary model for agent](https://learn.microsoft.com/ko-kr/microsoft-copilot-studio/authoring-select-agent-model)
...
| **초과 시 동작** | Prepaid 소진 시 → PAYG 자동 전환 (Azure 구독 연결 필요) | [Learn](https://learn.microsoft.com/ko-kr/microsoft-copilot-studio/requirements-messages-management#overage-enforcement) |
