...
title: "도구(커넥터) 추가"
short_title: "도구: 커넥터"
description: "기초편 #2: 문서검색 & 에스컬레이션 - 도구(커넥터) 추가"
order: 2
icon: "🔗"
category: workshop
parent: "ws2"
...
← [이전: Step 1. Agent 생성]({{ '/chapters/ws2-1-create-agent/' | relative_url }}) | [다음: Step 3. 도구: 플로우]({{ '/chapters/ws2-3-tool-flow/' | relative_url }}) →