---
layout: chapter
title: "도구 추가 (플러그인 커넥터)"
short_title: "도구: 플러그인 커넥터"
description: "기초편 #1: 블로그 포스트 에이전트 - 도구 추가 (플러그인 커넥터)"
order: 4
category: workshop
parent: "ws1"
---
...
← [이전: Step 3. 도구: MCP 커넥터]({{ '/chapters/ws1-3-tool-mcp/' | relative_url }}) | [다음: Step 5. 게시 및 배포]({{ '/chapters/ws1-5-publish/' | relative_url }}) →