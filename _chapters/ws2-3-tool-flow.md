...
title: "도구(플로우) 추가"
short_title: "도구: 플로우"
description: "기초편 #2: 문서검색 & 에스컬레이션 - 도구(플로우) 추가"
order: 3
icon: "🔄"
category: workshop
parent: "ws2"
...
← [이전: Step 2. 도구: 커넥터]({{ '/chapters/ws2-2-tool-connector/' | relative_url }}) | [다음: Step 4. 트리거 추가]({{ '/chapters/ws2-4-trigger/' | relative_url }}) →