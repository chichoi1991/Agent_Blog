...
| # | 실습 내용 | 소요 시간 |
|---|-----------|-----------|
| 1 | 에이전트 생성 및 지침 작성 | 15분 |
| 2 | 지식 소스 연결 (SharePoint · 메일) | 10분 |
| 3 | ThinQ MCP 도구 추가 | 15분 |
| 4 | Work IQ MCP 및 워크플로우 구성 | 20분 |
| 5 | AI Prompt 도구 및 HTML 응답 설계 | 20분 |
| 6 | Excel 데이터 필터링 + AI Prompt 연동 (심화) | 20분 |
| 7 | Teams 채널 배포 및 테스트 | 10분 |
